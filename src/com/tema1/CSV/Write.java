...
public class Write
{
    ...
    public void writeMedicPrimarCSV(Medic med)
    {
        try (var out = new BufferedWriter(new FileWriter("/C:/Users/mihai/Tema PAO/mediciprimari.csv",true)))
        {

            out.write(med.getNume() + "," + med.getCabinet() + "," + med.getSalariu() + '\n');
        }
        catch (IOException e)
        {
    ...
    public void writeMedicChirurgCSV(Medic med)
    {
        try (var out = new BufferedWriter(new FileWriter("/C:/Users/mihai/Tema PAO/medicichirurgi.csv",true)))
        {
